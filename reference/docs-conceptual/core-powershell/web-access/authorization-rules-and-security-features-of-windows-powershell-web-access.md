...
This layer offers the same security mechanisms that would evaluate connection
...
- An administrator has set up a private test environment, and wants to allow
